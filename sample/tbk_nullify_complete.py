...
def init(request):
    ...
    title = '<h1>Ejemplos Webpay - Transaccion Completa Anulacion</h1>'

    next_page = "http://127.0.0.1:8000/sample/tbk_nullify_complete/nullify"
    ...
    html = html + "<input id='buyOrder' name='buyOrder' type='text' />&nbsp&nbsp&nbsp&nbsp<br/><br/><br/>"
